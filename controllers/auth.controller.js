...
class AuthController {
  ...
  async registerUser(req, res) {
    try {
      ...
      const text = `A new client of First Name: ${user.firstName}, Last Name: ${
        user.lastName
      }, and Email: ${user.email} just signed up.${
        referral
          ? `The client was referred by the client of name:${referral.name} and Email:${referral.name}`
          : ""
      }`;
